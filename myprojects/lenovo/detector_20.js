...
document.body.style.fontFamily = 'sans-serif';
    ...
    function checkStability(rect) {
        ...
        if (stabilityCounter < LOCK_TARGET) {
            ...
            const base64Image = dbgCanvas.toDataURL("image/png"); 
...
const copy_colors = {
  0: '#ff8c00',  // orange - Goal Top Bar
  1: '#BA0C2F',  // red - Goal Net
  2: '#ffffff',  // white - Goal Side Bar
  3: '#ff8c00',  // orange - missed
  4: '#BA0C2F'   // red - saved by goli
...
const textShadows = {
  ...
  4: '0 0 5px #ffffff, 0 0 10px #ffffff'
};
...
function loading_check(){
    ...
    if(!check)return
    if(model_loaded_count >= model_total_count){
        check = false;
