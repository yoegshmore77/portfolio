//Derived from 41 readded AI and now it has both AI +CV
...
const centerToleranceX = roiW * 0.30;
const centerToleranceY = roiH * 0.30;
...
let dummy_video_grab = null;
    ...
    function checkStability(rect) {
        if (lastRect) {
            ...
            stabilityCounter = d < 50 ? stabilityCounter + 10 : Math.max(0, stabilityCounter - 1);
        } else {
            stabilityCounter = 1;
        }
        lastRect = rect;
