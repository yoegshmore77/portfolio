...
let dummy_video_grab = null;
    ...
    function checkStability(rect) {
        ...
        if (stabilityCounter < LOCK_TARGET) {
            ...
            scan_status_msg.innerText = "Found goal post!";
    ...
    function animate_game_container(){
          ...
          if(scl < 2.79){
            ...
            scan_status_msg.innerText = "Starting game in a moment";
...
function decideKeeperDive(angleRad) {
    ...
    lottery = 0;//lottery_bank[currentAttempt];//0;//getRandomInt(0,2);
...
let showGoalFlash_msg = false;
 ...
 scan_status_msg.innerText = "Scan a rectangualr shaped object";
 scan_status_msg.style.textShadow = '0 0 5px #000000';

    //yt
    /*
    //const scan_status_msg = document.createElement('div');
    const scan_status_msg = document.getElementById('scan_status_msg');
    //scan_status_msg.innerText = "";
    scan_status_msg.style.position = 'absolute';
    scan_status_msg.style.top = '55%';

    scan_status_msg.style.left = '50%';
    scan_status_msg.style.transform = 'translate(-50%, -50%)';
    scan_status_msg.style.color = '#ffffff';

    scan_status_msg.style.padding = '10px 20px';
    scan_status_msg.style.borderRadius = '12px';
    scan_status_msg.style.userSelect = 'none';
    scan_status_msg.style.opacity = '0';
    scan_status_msg.style.pointerEvents = 'none';

    scan_status_msg.style.fontWeight = '400';
    scan_status_msg.style.fontFamily = "Noto Sans", 'system-ui';
    scan_status_msg.style.whiteSpace = 'normal'; 
    scan_status_msg.style.textAlign = 'center'; 
    scan_status_msg.style.maxWidth = '90vw';  

    scan_status_msg.style.zIndex = '2000000';
    //scan_status_msg.style.setProperty('z-index', '20000000', 'important');
    scan_status_msg.style.display = 'block';
    scan_status_msg.style.fontSize = '30px';

    scan_status_msg.style.pointerEvents = 'none';

    scan_status_msg.innerText = "Scan a rectangualr shared object";

    //document.body.appendChild(scan_status_msg);
    */
/***********************************
 *  showGoalFlash
 ***********************************/
